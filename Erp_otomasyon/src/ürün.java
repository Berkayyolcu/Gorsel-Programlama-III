...
public void Show() {
            ...
            Label  label3 = new  Label (" Ürün Adý : ");
 	        ...
 	        Button button1 = new Button("Ürünü Ekle");
	        ...
	        Button button4 = new Button("Ürünleri Listele");
			...
			table.setModel(dtm);
			dtm.setColumnIdentifiers(new String [] {"üid","Adý","Adet","Birim_fiyatý"});
	       ...
	       button3.addActionListener((ActionListener) new ActionListener() {
		    ...
		    list.setTitle(" Ürün Ekleme ");
		    list.setSize(500,600);
		    	    		    	    		   
		    String[] columns=new String[]
		    		{"üid","Adý","Adet","Birim_fiyatý"};  
		    		    
		    String[][] cells=new String[][]{
		    		 {"1","Excalibur G770","1","7800 Tl"},
		    		 {"2","Siyah Erkek Oversize Bisiklet Yaka Baskýlý","2","50 Tl"},
		    		 {"3","LEGEND ESSENTIAL 2 Siyah","1","530 TL"},
		    		 {"4","Aqua Di Polo Unisex Kol Saati APL12C195H02","2","70 Tl"},
		    		 {"5","Pars Afrodizyak Parfüm 50ml Erkek Aphrodisiac","1","100 Tl"},
